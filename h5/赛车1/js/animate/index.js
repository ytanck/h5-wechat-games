var time = 30000
var CarDiv=[1,8,10,6,4,5,3,2,9,7];      //比赛结果顺序 
var timer='';
...
function placeAnimate1(){
    $('.place1').animate({left:'420px',top:'195px'},500,function(){placeAnimate12()})
}
function placeAnimate12(){
    $('.place2').show()
    $('.place2').animate({left:'185px',top:'150px'},500,function(){placeAnimate13()})
}
