...
function init() {
	...
	askb = 1;
	e = navigator.language; - 1 < document.URL.indexOf("page") ? (e = ["title_jmp_nolink.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp_nolink.png"], canvas.style.backgroundImage = "url(flyMeToHigher/title_jmp_nolink.jpg)", shms1 = "Browser game[SKY JUMP] SCORE=", shms2 = "Browser game[SKY JUMP]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?") : -1 < e.indexOf("ja") ? (e = ["title_jmp_jp.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp_jp.png"], canvas.style.backgroundImage = "url(flyMeToHigher/title_jmp_jp.jpg)", shms1 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v SCORE=", shms2 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v", shms3 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�𗧂�TIPS���Q�b�g���悤�I", shms4 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�A�C�e�����Q�b�g���悤�I") : (e = ["title_jmp.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp.png?d"], canvas.style.backgroundImage = "url(flyMeToHigher/title_jmp.jpg)", shms1 = "Browser game[SKY JUMP] SCORE=", shms2 = "Browser game[SKY JUMP]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?");
	img0 = new Image;
	img0.src = "flyMeToHigher/" + e[0];
	img0.onload = function() {
		gsts()
	};
	img1 = new Image;
	img1.src = "flyMeToHigher/" + e[1];
	img1.onload = function() {
		gsts()
	};
	img2 = new Image;
	img2.src = "flyMeToHigher/" + e[2];
	img2.onload = function() {
		gsts()
	};
	img7 = new Image;
	img7.src = "flyMeToHigher/" + e[3];
...
function gmovs() {
	...
	setTimeout(function () {
		window.P.showShare({
			score: scr_m,
			og: {
				title: "Jump high, fly higher, let's go." + " I got " + scr_m + " points in this game, come on!"
			}
		})
	}, 1000)
